...
export default function Resonanz() {
  return (
    <div className="container mx-auto min-h-full px-4 py-8">
      ...
      <p className="text-lg font-light mb-10">
        Die Bilder laden nicht nur zu einem Austausch untereinander ein, sondern
        auch dem Austausch unter den Betrachter:innen und der Person, die diese
        eingefangen hat. Eine Sprache, mit der wir uns austauschen können, ohne
