  ...
  return (
    <div className="container mx-auto min-h-full px-4 py-8">
      ...
      <p className="text-lg font-light mb-10">
        ...
        schaurigen Filmsequenzen? Warum fühlen wir uns von Dingen angezogen, die
        Angst und Unbehagen hervorrufen? Und wie verwandelt sich die
        Konfrontation mit dem Unheimlichen in einen Moment des Staunens und der
        Faszination?
      </p>
      <p className="text-lg font-light mb-10">
